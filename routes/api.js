...
loghandler = {
    notparam: {
        ...
        getApikey: 'salin link di atas mank buat apikey nya chat aja di wa wa.me/6285283427860 '
    },
    notkey: {
        status: false,
        creator: `${creator}`,
...
router.get('/find', async (req, res, next) => {
    ...
    if (apikey != 'AnggaGanz') return res.json(loghandler.invalidKey)
...
router.get('/tiktod', async (req, res, next) => {
	...
	if(!apikeyInput) return res.json(loghandler.notparam)
	if(apikeyInput != 'AnggaGanz') return res.json(loghandler.invalidKey)
